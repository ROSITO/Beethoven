...
| Validation tasks | Partial | Local commands and named profiles are appended as governed `validate` score tasks with policy gating and exact command approval; interactive desktop prompts remain. |
...
- add interactive desktop approval prompts and richer inspector output for
  governed validation and future diff/code actions.
